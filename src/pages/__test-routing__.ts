...
export const routingTests = {
  ...
  basicNavigation: {
    ...
    expected:
      'Navigation should work smoothly with correct URL updates and active tab highlighting',
  },
  ...
  breedPageNavigation: {
    ...
    expected:
      'Should navigate to breed page with correct URL parameter and breadcrumb',
  },
  ...
  urlParameterProcessing: {
    ...
    expected:
      'URL parameters should be processed correctly, query parameters should affect navigation',
  },
  ...
  invalidRouteHandling: {
    ...
    expected:
      'Invalid routes should show 404 page, invalid breeds should show breed not found message',
  },
  ...
  navigationStateManagement: {
    ...
    expected:
      'Active tab should always reflect current page, breed page should show special tab',
  },
